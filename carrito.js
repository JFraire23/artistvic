		...
		productosEnCarritoMoloch.forEach(platillo => {
			...
			div.innerHTML = `
					...
					<div class="carrito-platillo-cantidad">
						<small>Series</small>
						<p class="textos-carrito">${platillo.series}</p>
					</div>
					<div class="carrito-platillo-precio">
						<small>Repeticiones</small>
						<p class="textos-carrito">${platillo.repeticiones}</p>
					</div>
...
function vaciarCarrito(){
	...
	Swal.fire({
 	 	title: "¿Estas Seguro?",
  		text: ` se van a borrar todos los ejercicios`,
  		icon: "question",
  		...
  		if (result.isConfirmed) {
    		...
    		Swal.fire({
      		title: "Borrado",
      		text: "Todos tus ejercicios fueron borrados",
      		icon: "success"
    	});
  }
});
